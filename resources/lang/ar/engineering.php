...
return [
    ...
    'Choose An Authentication Method' => 'اختر طريقة المصادقة',
    'Two Factor Explanation' => 'بالإضافة إلى اسم المستخدم وكلمة المرور، سيتوجب عليك إدخال رمز يتم إرساله عبر التطبيق أو الرسائل النصية لتسجيل الدخول.',
     'App Instructions' => 'باستخدام تطبيق مصادقة مثل Google Authenticator أو Microsoft Authenticator أو Authy أو 1Password، امسح رمز QR أدناه.',
    'Manual Entry' => 'إذا واجهت مشكلة في استخدام رمز QR، اختر الإدخال اليدوي في التطبيق، وأدخل اسم المستخدم والرمز:',
    'Enter Code' => 'أدخل رمز التحقق',
     'Please Wait' => 'الرجاء الانتظار',
    'SMS Verify Title' => 'الرسائل القصيرة: تحقق من رقم الهاتف',
    'SMS Instruction' => 'أدخل رقم هاتفك المحمول مع رمز البلد وسنرسل لك رمز التحقق عند الطلب.',
    'Enter Mobile' => 'رقم الهاتف مع رمز الدولة...',
