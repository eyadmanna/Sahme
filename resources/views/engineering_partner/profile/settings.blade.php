                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ request()->routeIs('engineering.profile') ? 'active' : '' }}" href="{{route('engineering.profile')}}">@lang('engineering.Overview')</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div id="kt_signin_email">
                                <div class="fs-6 fw-bold mb-1">@lang('admin.Email')</div>
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-6 mb-4 mb-lg-0">
                                            <div class="fv-row mb-0">
                                                <label for="emailaddress" class="form-label fs-6 fw-bold mb-3">@lang('engineering.Enter New Email Address')</label>
                                                <input type="email" class="form-control form-control-lg form-control-solid" id="emailaddress" placeholder="@lang('admin.Email')" name="email" value="{{$user->name}}" />
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="fv-row mb-0">
                                                <label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3">@lang('engineering.Confirm Password')</label>
                                                <input type="password" class="form-control form-control-lg form-control-solid" name="confirmemailpassword" id="confirmemailpassword" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <button id="kt_signin_submit" type="button" class="btn btn-primary me-2 px-6">@lang('engineering.Update Email')</button>
                                        <button id="kt_signin_cancel" type="button" class="btn btn-color-gray-500 btn-active-light-primary px-6">@lang('engineering.Cancel')</button>
                                    </div>
                                </form>
                                <!--end::Form-->
                            </div>
                            ...
                            <div id="kt_signin_email_button" class="ms-auto">
                                <button class="btn btn-light btn-active-light-primary">@lang('engineering.Change Email')</button>
                            </div>
                            <!--end::Action-->
                        </div>
                        <!--end::Email Address-->
...
@include('engineering_partner.partial.profile_settings_js')
