                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <div class="symbol symbol-100px symbol-circle mb-7">
                                    <img src="{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : $imgUrl}}" alt="image" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                ...
                                <div class="mb-9">
                                    <!--begin::Badge-->
                                    <div class="badge badge-lg badge-light-primary d-inline">{{ $user->getRoleNames()->join(', ') }}</div>
                                    <!--begin::Badge-->
                                </div>
                                <!--end::Position-->
                                <!--begin::Info-->
                                    ...
                                    <div id="kt_modal_update_user_user_info" class="collapse show">
                                        ...
                                        <div class="mb-7">
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <style>.image-input-placeholder { background-image: url('{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : 'assets/media/svg/avatars/blank-dark.svg'}}'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('{{$user->avatar ? asset('uploads/usersImage/' . $user->avatar) : 'assets/media/svg/avatars/blank-dark.svg'}}'); }</style>
